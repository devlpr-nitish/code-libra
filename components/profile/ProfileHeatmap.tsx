...
export const HEATMAP_THEMES: { name: ColorTheme; label: string; previewColors: string[]; hex: string }[] = [
    {
        name: 'green',
        label: 'Green',
        previewColors: ['bg-green-200/40 dark:bg-green-900/40', 'bg-green-300/60 dark:bg-green-800/60', 'bg-green-400/80 dark:bg-green-600/80', 'bg-green-500 dark:bg-green-500'],
        hex: '#10b981' // emerald-500
    },
    {
        name: 'blue',
        label: 'Blue',
        previewColors: ['bg-blue-200/40 dark:bg-blue-900/40', 'bg-blue-300/60 dark:bg-blue-800/60', 'bg-blue-400/80 dark:bg-blue-600/80', 'bg-blue-500 dark:bg-blue-500'],
        hex: '#3b82f6' // blue-500
    },
    {
        name: 'purple',
        label: 'Purple',
        previewColors: ['bg-purple-200/40 dark:bg-purple-900/40', 'bg-purple-300/60 dark:bg-purple-800/60', 'bg-purple-400/80 dark:bg-purple-600/80', 'bg-purple-500 dark:bg-purple-500'],
        hex: '#a855f7' // purple-500
    },
    {
        name: 'orange',
        label: 'Orange',
        previewColors: ['bg-orange-200/40 dark:bg-orange-900/40', 'bg-orange-300/60 dark:bg-orange-800/60', 'bg-orange-400/80 dark:bg-orange-600/80', 'bg-orange-500 dark:bg-orange-500'],
...
export default function ProfileHeatmap({ user, theme, onThemeChange }: ProfileHeatmapProps) {
    ...
    const getColorClass = (intensity: number, theme: ColorTheme) => {
        ...
        if (theme === 'green') {
            ...
            switch (intensity) {
                case 1: return "bg-blue-200/40 dark:bg-blue-900/40";
                case 2: return "bg-blue-300/60 dark:bg-blue-800/60";
                case 3: return "bg-blue-400/80 dark:bg-blue-600/80";
                case 4: return "bg-blue-500 dark:bg-blue-500";
            }
            ...
            switch (intensity) {
                case 1: return "bg-orange-200/40 dark:bg-orange-900/40";
                case 2: return "bg-orange-300/60 dark:bg-orange-800/60";
                case 3: return "bg-orange-400/80 dark:bg-orange-600/80";
